...
async def process_start_command(message: Message):
    ...
    button = InlineKeyboardButton(text="Кнопка", callback_data="button_preseed")
    ...
    logger.debug("Выходим из хэндлера, обрабатывающий нажатие на инлайн-кнопку")
...
async def process_text(message: Message):
    ...
    logger.debug("Выходим из хэндлера, обрабатывающего текс")